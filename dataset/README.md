...
A Região Integrada de Segurança Pública – RISP é uma divisão territorial administrativa utilizada pela Secretaria de Estado de Justiça e Segurança Pública para a organização e análise das informações de segurança pública em Minas Gerais. Atualmente, o Estado possui 19 RISPs.

A série histórica de Furto Consumado disponibilizada pela SEJUSP contempla registros a partir de 2012. A documentação oficial da Secretaria apresenta a evolução dos registros de Furto Consumado no período de 2012 em diante, tendo como fonte o Armazém Sisp – Módulo REDS.

Os dados são passíveis de atualização, considerando a dinâmica dos registros no sistema de origem.

## Painel de Furtos Consumados

[Painel de Furtos Consumados](https://app.powerbi.com/view?r=eyJrIjoiNzY4Njk3ZjUtZjE4Yi00YzZmLWFjZmEtZjU5NDZlNzc1NDI0IiwidCI6ImU1ZDNhZTdjLTliMzgtNDhkZS1hMDg3LWY2NzM0YTI4NzU3NCJ9)
